...
export default function MobileCartContentItem({item, price}: CartContentItemProps) {
    ...
    return <div className=" cart dark:shadow-sm dark:shadow-white flex hover:cursor-pointer border shadow-sm self-center flex-row justify-between h-[30%] w-full">
        ...
        <div onClick={
            removeFromCart
        } className="flex-col content-center justify-center h-full p-10 text-red-500 hover:cursor-pointer">
